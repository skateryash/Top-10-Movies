...
MOVIE_DB_API_KEY = "490b672811eb13c76ef92981135ab813"
...
class RateMovieForm(FlaskForm):
    new_rating = StringField('Your Rating Out of 10 e.g. 7.8')
...
def add_movie():
    ...
    if form.validate_on_submit():
        movie_title = form.title.data        # request.form.get("title")
        params = {
...
def find_movie():
    ...
    if movie_api_id:
        movie_api_url = f"{MOVIE_DB_INFO_URL}" + "/" + f"{movie_api_id}"
